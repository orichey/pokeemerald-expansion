...
static const struct HealLocation sHealLocationsPokemonCenter[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_RANCH - 1] =
    {
        .group = MAP_GROUP(RANCH),
        .map = MAP_NUM(RANCH),
        .x = 53,
        .y = 68,
    },
    [HEAL_LOCATION_MELTING_SNOW - 1] =
    {
        .group = MAP_GROUP(MELTING_SNOW_TOWN),
        .map = MAP_NUM(MELTING_SNOW_TOWN),
        .x = 10,
        .y = 10,
    },
};
...
static const u8 sHealNpcLocalId[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_RANCH - 1] = 1,
    [HEAL_LOCATION_MELTING_SNOW - 1] = 1,
};
