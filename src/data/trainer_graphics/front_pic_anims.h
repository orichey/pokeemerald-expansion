...
static const union AnimCmd *const sAnims_JSOBoy[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_JSOGirl[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_JSOBOY] = sAnims_JSOBoy,
    [TRAINER_PIC_JSOGIRL] = sAnims_JSOGirl,
};
