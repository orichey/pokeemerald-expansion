const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_JSOBOY] = TRAINER_PIC_JSOBOY,
    [FACILITY_CLASS_JSOGIRL] = TRAINER_PIC_JSOGIRL,
    [FACILITY_CLASS_FARMER] = TRAINER_PIC_FARMER,
};
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_JSOBOY] = TRAINER_CLASS_JSOBOY,
    [FACILITY_CLASS_JSOGIRL] = TRAINER_CLASS_JSOGIRL,
    [FACILITY_CLASS_FARMER] = TRAINER_CLASS_FARMER,
};
