...
const u8 gText_LeagueChamp[] = _("Congratulations on beating my hack!");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Ecodia region.");
