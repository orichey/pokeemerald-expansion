...
static void Task_NewGameBirchSpeech_Init(u8 taskId)
{
    ...
    //PlayBGM(MUS_PMD_RESCUETEAM_QUIZ);
    ShowBg(0);
    ShowBg(1);
}
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_CASTFORM);
...
{
    return CreateMonPicSprite_Affine(SPECIES_CASTFORM_RAINY, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
