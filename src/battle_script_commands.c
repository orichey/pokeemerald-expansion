...
static const u16 sNaturePowerMoves[BATTLE_TERRAIN_COUNT] =
{
    ...
    [BATTLE_TERRAIN_ROUTE]      = MOVE_ENERGY_BALL,
    ...
    [BATTLE_TERRAIN_NEWCAVE]    = MOVE_EARTH_POWER,
    ...
    [BATTLE_TERRAIN_LAKE]       = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_ROCKY]      = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_SEA]        = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_SNOWCAVE]   = MOVE_ICE_BEAM,
    [BATTLE_TERRAIN_SNOWMOUNTAIN]   = MOVE_ICE_BEAM,
    [BATTLE_TERRAIN_SNOWY]      = MOVE_ICE_BEAM,
