...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/magmxtiles.4bpp.lz");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/magmxtiles.bin.lz");
