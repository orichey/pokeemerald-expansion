...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
...
#endif
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("You ended the battle.\p"),
    ...
    [STRINGID_PKMNBUFFETEDBYSANDSTORM]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is buffeted by the storm!"),
    [STRINGID_PKMNPELTEDBYHAIL]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} is buffeted by the storm!"),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_SMOKE]              = STRINGID_ITISRAINING
};
