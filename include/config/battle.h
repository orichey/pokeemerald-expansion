...
#define B_FLAG_NO_CATCHING          FLAG_UNUSED_0x8F7     // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           FLAG_UNUSED_0x8F8     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
